...
export const EXTERNAL_LINKS = {
  ...
  discord: "https://hanzo.io/discord",
  twitter: "https://twitter.com/hanzoai",
  productHunt: "https://www.producthunt.com/products/hanzo-2",

  hanzoRun: meta.repository.url.replace("hanzo.git", "backend"),
  hanzoRunGitHub: meta.repository.url.replace("hanzo.git", "backend"),
  // prettier-ignore
  hanzoRunDeploy: `https://deploy.cloud.run/?git_repo=${meta.repository.url.replace(".git", "Run")}.git`,

  hanzoAppHostName: "hanzo.app",
