...
export default function Logo({ size = 1.5, ...props }: ILogoProps) {
  ...
  return (
    <svg
      ...
      aria-labelledby="hanzo-logo-title"
      role="img"
      {...props}
    >
      <title id="hanzo-logo-title">Hanzo</title>

      <defs>
        <linearGradient x1="83.349%" y1="50%" x2="0%" y2="50%" id="hanzo-b">
          <stop stopColor="#F0A" offset="0%" />
          <stop stopColor="#FA0" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="16.276%" x2="50%" y2="100%" id="hanzo-c">
          <stop stopColor="#4200FF" offset="0%" />
          <stop stopColor="#F0A" offset="100%" />
        </linearGradient>
        <linearGradient x1="83.052%" y1="50%" x2="0%" y2="50%" id="hanzo-d">
          <stop stopColor="#0AF" offset="0%" />
          <stop stopColor="#0FA" offset="100%" />
        </linearGradient>
        <linearGradient x1="100%" y1="50%" x2="16.614%" y2="50%" id="hanzo-e">
          <stop stopColor="#0AF" offset="0%" />
      ...
      <path
        ...
        fill="#4200FF"
      />
      <path d="M6 5v6H0V5h6zM5 6H1v4h4V6z" fill="url(#hanzo-c)" />
      <path
