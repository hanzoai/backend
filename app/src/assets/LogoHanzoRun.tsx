...
export interface ILogoHanzoRunProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

export default function LogoHanzoRun({
  size = 1.5,
  ...props
}: ILogoHanzoRunProps) {
  ...
  return (
    <svg
      ...
      aria-labelledby="hanzo-run-logo-title"
      role="img"
      {...props}
    >
      <title id="hanzo-run-logo-title">Hanzo Run</title>
