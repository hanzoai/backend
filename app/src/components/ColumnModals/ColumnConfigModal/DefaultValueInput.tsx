  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem
          value="dynamic"
          disabled={!projectSettings.hanzoRunUrl}
          sx={{
        ...
        >
          <ListItemText
                ...
                <>
                  ...
                  <Typography color="error" variant="inherit" component="span">
                    ...
                    <span
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        openHanzoRunModal({ feature: "Dynamic Default Value" });
                      }}
                    >
                      Cloud Function
                    </span>
            ...
            secondary="Write code to set the default value using Hanzo Run"
          />
        </MenuItem>
      </TextField>
