...
import { hanzoRunAtom } from "@src/atoms/projectScope";
import { CloudLogFilters } from "@src/atoms/tableScope";

export const cloudLogFetcher = (
  endpointRoot: string,
  hanzoRun: ReturnType<typeof hanzoRunAtom["read"]>,
  projectId: string,
  ...
  switch (cloudLogFilters.type) {
    case "extension":
      logQuery.push(`logName = "projects/${projectId}/logs/hanzo-logging"`);
    ...
    case "audit":
      logQuery.push(`logName = "projects/${projectId}/logs/hanzo-audit"`);
