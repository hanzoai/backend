...
export default function ConnectTableSelect({
  ...
  useEffect(() => {
    if (!algoliaAppId && hanzoRun) {
      hanzoRun({ route: runRoutes.algoliaAppId }).then(
