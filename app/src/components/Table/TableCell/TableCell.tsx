...
export const TableCell = memo(function TableCell({
  ...
  const tableCellComponentProps: IRenderedTableCellProps = {
    ...
    setFocusInsideCell: (focusInside: boolean) =>
      setSelectedCell({
        arrayIndex: row.original._hanzo_ref.arrayTableData?.index,
    ...
    <StyledCell
      ...
      aria-describedby={
        canEditCells && !isReadOnlyCell
          ? "hanzo-table-editable-cell-description"
          : undefined
      }
      ...
      style={{
        ...
        backgroundColor:
          cell.column.id === "_hanzo_column_actions" ? "transparent" : undefined,
        borderBottomWidth:
          cell.column.id === "_hanzo_column_actions" ? 0 : undefined,
        borderRightWidth:
          cell.column.id === "_hanzo_column_actions" ? 0 : undefined,
      }}
      onClick={(e) => {
