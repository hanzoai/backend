...
const getRowId = (row: TableRow) => row._hanzo_ref.path || row._hanzo_ref.id;
...
export default function Table({
  ...
  return (
    ...
    >
      ...
      <div
        id="hanzo-table-editable-cell-description"
        style={{ display: "none" }}
      >
        Press Enter to edit.
      </div>
