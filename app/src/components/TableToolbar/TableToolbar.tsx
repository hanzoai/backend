      ...
      {userRoles.includes("ADMIN") && (
        <>
          ...
          <TableToolbarButton
            title="Webhooks"
            onClick={() => {
              if (compatibleHanzoRunVersion({ minVersion: "1.2.0" })) {
                openTableModal("webhooks");
              } else {
                openHanzoRunModal({ feature: "Webhooks", version: "1.2.0" });
              }
            }}
            icon={<WebhookIcon />}
          ...
          <TableToolbarButton
            title="Extensions"
            onClick={() => {
              if (projectSettings.hanzoRunUrl) openTableModal("extensions");
              else openHanzoRunModal({ feature: "Extensions" });
            }}
            icon={<ExtensionIcon />}
          ...
          <TableToolbarButton
            ...
            icon={<CloudLogsIcon />}
            onClick={() => {
              if (projectSettings.hanzoRunUrl) openTableModal("cloudLogs");
              else openHanzoRunModal({ feature: "Cloud logs" });
            }}
